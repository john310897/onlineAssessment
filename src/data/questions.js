export const questions = [
    {
        question_image: 'https://en.testometrika.com/upload/questions/9a3/9a3e5c664c57fefe9781ed343a0b4224.svg',
        question_label: 'Which shape should be in the rightmost cell with a question mark?',
        type: 'image_question',
        options: [
    ...
    {
        question_image: 'https://en.testometrika.com/upload/questions/61f/61f8311dc95818b190b639bb10e7ff0a.svg',
        question_label: 'Which shape should be in the rightmost cell with a question mark?',
        type: 'image_question',
        options: [
    ...
    {
        question_image: 'https://en.testometrika.com/upload/questions/56e/56e7575fce5c66102f68965309041c81.svg',
        question_label: 'Which shape should be in the rightmost cell with a question mark?',
        type: 'image_question',
        options: [
    ...
    {
        question_image: 'https://en.testometrika.com/upload/questions/172/1720017b4d9ac6239940206e70cbf4f1.svg',
        question_label: 'Which shape should be in the rightmost cell with a question mark?',
        type: 'image_question',
        options: [
            'https://en.testometrika.com/upload/answers/d8d/d8d19b6f3fd4e3206920722be30fddef.svg',
            'https://en.testometrika.com/upload/answers/91b/91b560ed07d65a749b5af92df66017d7.svg',
            'https://en.testometrika.com/upload/answers/2d1/2d1274fee63b4cfcfa506a75872b34e5.svg',
            'https://en.testometrika.com/upload/answers/0fc/0fc766e152640ab512fd60c8d6ac5f36.svg',
            'https://en.testometrika.com/upload/answers/30c/30c98696f7de22a3a568a53454ae9f03.svg',
            'https://en.testometrika.com/upload/answers/ff6/ff6cade322e22c45221bd9348347cd61.svg'
        ]
    },
    {
